...
public class SelfBalancingBinarySearchTreeTest
{
    ...
    {            
        ...
        // create list of Integers() to insert into tree
        Integer[] intArray = {1,3,2,4,3,5,4,6,5,7,6,8,7,9,8};
        List<Integer> nodeValues = Arrays.asList(intArray);
        
        // insert list elements into tree
//        for (Integer i:nodeValues) sbbst.insert( nodeValues.get(i));
